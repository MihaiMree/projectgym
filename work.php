...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.min.js" integrity="sha384-cuYeSxntonz0PPNlHhBs68uyIAVpIIOZZ5JqeqvYYIcEL727kskC66kF92t6Xl2V" crossorigin="anonymous"></script>    <link rel="stylesheet" href="assets/style/style.css">
...
<div class="d-flex flex-column flex-shrink-0 bg-black" style="width: 7.1rem;height: 100vh">
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        ...
        <li>
            <a href="work.php" class="nav-link active py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Dashboard" data-bs-original-title="Dashboard">
