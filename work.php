...
<div class="d-flex flex-column flex-shrink-0 bg-black" style="width: 7.1rem;height: 100vh">
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
        ...
        <li>
            <a href="work.php" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Dashboard" data-bs-original-title="Dashboard">
