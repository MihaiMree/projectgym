...
if(isset($_POST['table_name']) && isset($_POST['username'])){
    ...
    if($result->num_rows > 0){
        ...
        echo "<th scope='col'> Reps Set 1</th> <th scope='col'>Gewicht Set 1</th><th scope='col'> Reps Set 2</th> <th scope='col'>Gewicht Set 2</th><th scope='col'> Reps Set 3</th> <th scope='col'>Gewicht Set 3</th>";
        echo "</thead>";
