...
<form method="POST" action="assets/config/legs/sqat.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/legs/sqat.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/legs/hack.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/legs/hack.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/legs/rdl.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/legs/rdl.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/legs/exten.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/legs/exten.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/legs/legcurl.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/legs/legcurl.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/legs/calf.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/legs/calf.jpg" class="oefening-img"> </div>
