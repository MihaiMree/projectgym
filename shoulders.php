...
<form method="POST" action="assets/config/shoulders/shoulder_press.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/shoulder/shoulder_press.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/shoulders/raise.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/shoulder/raise.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/shoulders/cable_raise.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/shoulder/cb_raise.jpg" class="oefening-img"> </div>
...
<form method="POST" action="assets/config/shoulders/rev_cable_raise.php">
    <div class="container">
        <div class="oefening"> <img src="assets/img/shoulder/cb_reverse_fly.jpg" class="oefening-img"> </div>
